...
<main>
  <section class="top" id="top">
    <div class="top-inner">
      <h1 class="top-title" id="top-title">Himeka<br>Yamamoto's<br>Portfolio</h1>
      <p class="top-subtitle" id="top-subtitle">Web Designer & Front-end Developer</p>
    </div>
  </section>
...
チーム間の橋渡しを意識した業務にも取り組んでいます。</p>
  ...
  <section class="skills" id="skills">
    ...
    <ul class="skills-list">
      <li class="skill-item">
        <span class="skill-name">HTML / CSS（SCSS）</span>
      ...
      <li class="skill-item">
        <span class="skill-name">Adobe Illustrator / Photoshop</span>
        <ul class="skill-detail">
          <li>基本操作可能</li>
          <li>画像の書き出しや簡単な修正</li>
  ...
  <section class="works" id="works">
    ...
    <div class="works-scope">
      <p class="works-scope-title">共通：担当範囲</p>
      <ul class="works-scope-list">
